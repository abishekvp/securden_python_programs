...
class TaxiModel:
    ...
    def update_taxi(taxi_id, customer_id, booking_id, pickup_point, drop_point, pickup_time, drop_time):
        ...
        cid = eval(Taxi_Data.customer_id)
        cid.append(customer_id)
        Taxi_Data.customer_id = str(cid)
    ...
    def book_taxi(customer_id, pickup, drop, pickup_time):
        ...
        if drop_time > 24:drop_time = drop_time - 24
        ...
        TaxiModel.update_taxi(taxi_id, customer_id, booking_id, pickup_point, drop_point, pickup_time, drop_time)
        return taxi_id
